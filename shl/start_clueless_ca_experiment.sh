...
do
    ...
    do
        ...
        cp collision-avoidance-clueless.argos collision-avoidance_instance.argos
        ...
        sed -i "s|££ SAFE_EPOCHS ££|0|" "main_instance.lua"
        ...
        sed -i "s|position="0,0,0"|$P|" "collision-avoidance_instance.argos"

        P=$(cat "$INPUT_PATH/f$N_FAULTS-s$SEED.txt" | grep rotation | tail -n 1 | awk '{print $4}')
        sed -i "s|orientation="0,0,0"|$P|" "collision-avoidance_instance.argos"
