...
INPUT_PATH="$WORK_DIR/v1.0.3_pt-informed/$DAMAGE_MODULE"

# create an output directory for the experiment results
OUTPUT_PATH="$WORK_DIR/v1.0.3_pt-clueless/$DAMAGE_MODULE"
mkdir -p $OUTPUT_PATH
...
do
    ...
    do
        ...
        cp phototaxis-clueless.argos phototaxis_instance.argos
