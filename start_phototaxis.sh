...
do
    ...
    then
        ...
        do
            ...
            sed -i "s|££ EXPERIMENT_STEPS ££|200000|" "main_instance.lua"
            ...
            argos3 -n -c run-phototaxis_instance.argos | grep -v INFO > "$OUTPUT_PATH/$DAMAGE_MODULE-$BIAS-$N_FAULTS-$SEED.txt"
        done
    else
