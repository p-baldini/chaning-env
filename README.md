...
```
docker build --network=host --tag quay.io/p-baldini/experiment_2025-05-05:1.0.3 .
docker push quay.io/p-baldini/experiment_2025-05-05:1.0.3
```
...
docker run --rm --network=host -e DISPLAY \
    ...
    -e END_SEED=2 \
    -e WORK_DIR=out \
    quay.io/p-baldini/experiment_2025-05-05:1.0.3
```
