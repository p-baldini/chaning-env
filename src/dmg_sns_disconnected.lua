...
-- A disconnected input does not force the value on the BN state but leaves it
-- free to change. Cycle the sensory inputs and, if not broken, force their
-- values in the BN state.
-- 
