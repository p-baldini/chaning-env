...
-- Create a map saying for each light sensor its broken value.
local values = {}
for i = 1, 24 do
    values[i] = math.random(0, 1)
end
...
-- A fixed input forces the value on the BN state. Cycle the sensory inputs
